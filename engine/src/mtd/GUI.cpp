...
GUI::DrawEvent & GUI::DrawEvent::operator=(const GUI::DrawEvent & other)
{
	this->type = other.type;
	switch( this->type )
	{
	case GUI::DrawEvent::Type::TEXT:
		this->text = other.text;
		break;
	case GUI::DrawEvent::Type::IMAGE:
...
void GUI::DrawEvent::Draw( irr::video::IVideoDriver * videoDriver )
{
	switch( this->type )
	{
	case GUI::DrawEvent::Type::TEXT:
...
GUI::DrawEvent::DrawEvent( Font * font, Rectanglei destiny, Color color, char * str )
{
	this->type = GUI::DrawEvent::Type::TEXT;
	this->text.font = font;
...
GUI::DrawEvent::DrawEvent( Texture * texture, Rectanglei source, Rectanglei destiny, Color color )
{
	this->type = GUI::DrawEvent::Type::IMAGE;
...
GUI::DrawEvent::DrawEvent()
{
	this->type = GUI::DrawEvent::Type::NONE;
}

GUI::DrawEvent::DrawEvent( const GUI::DrawEvent & other )
{
	(*this) = other;
}
...
void GUI::PrintOneBufferLineImplicitly( char * str, int width, int height )
{
	...
	this->toDraw.insert( this->toDraw.end(), GUI::DrawEvent( this->currentFont, rectangle, this->currentColor, str ) );
