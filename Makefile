...
ENGINECOREOBJECTS = engine\\bin\\Camera.o engine\\bin\\CollisionShapeManager.o engine\\bin\\Engine.o engine\\bin\\EngineRayTraceData.o engine\\bin\\EventReceiverIrrlicht.o engine\\bin\\EventResponser.o engine\\bin\\Model.o engine\\bin\\Entity.o engine\\bin\\StringToEnter.o engine\\bin\\GUI.o engine\\bin\\TimeCounter.o engine\\bin\\Window.o engine\\bin\\World.o engine\\bin\\CollisionObjectManager.o engine\\bin\\DllImporter.o engine\\bin\\ClassFactoryBase.o engine\\bin\\ModulesFactory.o engine\\bin\\CollisionShapeConstructor.o
